...
wss.on('connection', function (ws, req) {
    ...
    authenticator.verify(url_parts.query.id, url_parts.query.sig).then(function (match) {
        if (match) clientSockets.addWSConnection(url_parts.query.id, url_parts.query.userId, ws);else ws.close();
    });
});
